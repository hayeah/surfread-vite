 ...
 */
export function getSelectionContext(selection: Selection, wordLimit: number = 200): string {
  ...
  function getTextAroundSelection(
    ...
    let offset = traverseFn === getPreviousTextNode ? range.startOffset : range.endOffset
